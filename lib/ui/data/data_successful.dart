...
class DataSuccessWidget extends StatefulWidget {
 const  DataSuccessWidget({super.key, this.data});
 final dynamic data;

  @override
  State<DataSuccessWidget> createState() => _DataSuccessWidgetState();
}

class _DataSuccessWidgetState extends State<DataSuccessWidget> {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          decoration:  BoxDecoration(
                              color:!state.isDarkMode ? Colors.black :const Color(0xffF5F7FE),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Your Data transaction has been successfully completed.',
                                      style:Theme.of(context).textTheme.displaySmall!
                                          .copyWith(
                                              fontWeight: FontWeight.w800,
                                              fontSize: 12),
                                    ...
                                    SummaeyCard(
                                      ...
                                      secondText: '${widget.data['serviceProvider']}',
                                    ),
                                    SummaeyCard(
