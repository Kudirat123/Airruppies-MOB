...
class ActiveSaving extends StatefulWidget {
  const ActiveSaving({super.key});

  @override
  State<ActiveSaving> createState() => _ActiveSavingState();
}

class _ActiveSavingState extends State<ActiveSaving> {
  ...
  Future<void> getUserSavingsList() async {
    loading = true;
    userSavingsList = await SavingsService().getUserSavingsList(context);
    setState(() {
      loading = false;
    });
  }
                              ...
                              children: [
                                ...
                                ClipRRect(
                                  ...
                                  child: LinearProgressIndicator(
                                    value: double.parse(userSavingsList![index]
                                            .completion
                                            .toString()) /
                                        100,
                                    minHeight: 7,
