...
class BvnOtp extends StatefulWidget {
 ...
 final Map<String, dynamic>? bvn;
  ...
  @override
  State<BvnOtp> createState() => _BvnOtpState();
}

class _BvnOtpState extends State<BvnOtp> {
  String? currentText;
  ...
  void sendOtp() {
    RegistrationSerice().resendBvnOtp(context, widget.bvn!);
  }
              ...
              children: [
                Column(
                  children: [
                    ...
                    Text(
                        'An authentication code has been sent to ${widget.data!['phone']}',
                            ...
                            !reached
                                ...
                                : InkWell(
                                    onTap: () {
                                      ...
                                      Modal().success('Otp sent', context);
                                      setState(() {
                                        alert = DateTime.now()
                    ...
                    MyButton(
                        ...
                        onPressed: () {
                          ...
                          RegistrationSerice().submitBvnOtp(context, body);
                        }),
                    const SizedBox(
                      height: 20,
                    ),
