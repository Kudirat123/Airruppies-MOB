...
class BankBeneficiaryWidget extends StatefulWidget {
    const BankBeneficiaryWidget({super.key});

  @override
  State<BankBeneficiaryWidget> createState() => _BankBeneficiaryWidgetState();
}

class _BankBeneficiaryWidgetState extends State<BankBeneficiaryWidget> {
  @override
